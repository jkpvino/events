                        ...
                        <div class="section-content">
                            <article class="event">
                                <div class="event-thumbnail">
                                    <figure class="event-image">
                                        <div class="image-wrapper"><img src="<?php echo base_url() ?>assets/img/event-img-01.jpg"></div>
                                    </figure>
                                    <figure class="date">
                            ...
                            <article class="event">
                                <div class="event-thumbnail">
                                    <figure class="event-image">
                                        <div class="image-wrapper"><img src="<?php echo base_url() ?>assets/img/event-img-02.jpg"></div>
                                    </figure>
                                    <figure class="date">
                            ...
                            <article class="event">
                                <div class="event-thumbnail">
                                    <figure class="event-image">
                                        <div class="image-wrapper"><img src="<?php echo base_url() ?>assets/img/event-img-03.jpg"></div>
                                    </figure>
                                    <figure class="date">
