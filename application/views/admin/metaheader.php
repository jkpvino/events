	...
	<!-- Core JS files -->
	<script type="text/javascript" src="<?php echo base_url('assests/admin'); ?>/assets/js/plugins/loaders/pace.min.js"></script>
	...
	<script type="text/javascript" src="<?php echo base_url('assests/admin'); ?>/assets/js/plugins/loaders/blockui.min.js"></script>
	<!-- /core JS files -->
